...
def register_stack_rigid_3d(
    ...
    *,
    ...
    details = {
        ...
        "time_shifts_zyx_raw": shifts_zyx.copy(),
        "time_shifts_yx_raw": shifts_zyx[:, 1:].copy(),
        "rotation_shifts_zyx_deg": rotations_zyx_deg,
        "rotation_shifts_deg": rotations_zyx_deg[:, 0],
        "rotation_shifts_zyx_deg_raw": rotations_zyx_deg.copy(),
        "rotation_shifts_deg_raw": rotations_zyx_deg[:, 0].copy(),
